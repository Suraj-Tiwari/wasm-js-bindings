...
export function addMessageInToImports(imports, obj, get_export) {
  if (!("message_in" in imports)) imports["message_in"] = {};
  imports["message_in"]["jscall"] = function(arg0, arg1, arg2) {
    const memory = get_export("memory");
    const realloc = get_export("canonical_abi_realloc");
    const ptr0 = arg0;
    const len0 = arg1;
    const ret = obj.jscall(UTF8_DECODER.decode(new Uint8Array(memory.buffer, ptr0, len0)));
